...
$external_docs = @{
    ...
    "uno.themes"         = @{ ref="e135280afafd70722b5e4eabef957d8375aad5d9" }  #latest master commit
    ...
    "uno.extensions"     = @{ ref="2aed463c8fbd89b434a428dffa75c691f3c89005" }  #latest main commit
